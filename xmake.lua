...
-- llvm_prefix = home_dir .. "/project/LLVM"
-- target_triplet = nil
...
boost_prefix = home_dir .. "/.local/boost"

add_cxxflags("-std=c++23")
add_includedirs("src")
add_includedirs(".")
-- for boost
add_includedirs(boost_prefix .. "/include/")
add_linkdirs(boost_prefix .. "/lib/")
